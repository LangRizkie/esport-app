...
class ButtonStyle {
  ...
  static Inset = classNames(
    'absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-black group-hover:-translate-x-0 group-hover:-translate-y-0'
  )

  static AbsoluteInset = classNames(
    'absolute inset-0 w-full h-full bg-white border-2 border-black group-hover:bg-black'
  )
